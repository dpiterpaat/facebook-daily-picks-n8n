...
> ⚠️ **Disclaimer** — The picks are generated by an AI that can and will make mistakes. Always double-check the listing directly on Facebook Marketplace and stay cautious of scams before taking any action.
...
- The LLM evaluates listings based on student suitability (price, location, practicality) view the full [system prompt](/System%20Prompt.md) for more details
